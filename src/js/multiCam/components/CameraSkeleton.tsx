...
export const CameraSkeleton: React.FC = () => {
  return (
    <div className="mb-6 p-4 bg-neutral-800 rounded-lg animate-pulse">
      ...
      <div className="space-y-2">
        {[1, 2, 3].map((i) => (
          <div key={i} className="p-3 bg-neutral-700 rounded flex flex-col">
            <div className="flex justify-between mb-1">
              <div className="h-4 w-32 bg-neutral-600 rounded"></div>
              <div className="h-4 w-20 bg-neutral-600 rounded"></div>
            </div>
